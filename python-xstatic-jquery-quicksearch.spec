...
Version:        XXX
Release:        1%{?dist}
Summary:        JQuery.quicksearch JavaScript library packaged for setuptools

License:        MIT
URL:            http://git.openstack.org/cgit/stackforge/xstatic-jquery.quicksearch/
...
%description
JQuery.quicksearch javascript library packaged for
...
%{python_sitelib}/xstatic/pkg/jquery_quicksearch
